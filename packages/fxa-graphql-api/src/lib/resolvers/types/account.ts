...
@ObjectType({ description: "The current authenticated user's Firefox Account record." })
export class Account {
  ...
  @Field(type => [Subscription], { description: 'Active subscriptions for the user.' })
  ...
  @Field(type => [AttachedClient], { description: 'Client sessions attached to the user.' })
